...
import ir.aspireapps.identifyservice.repo.RefreshTokenRepository;
...
public class RefreshTokenService {
    ...
    public boolean verifyAndRevoke(@NotNull String refreshToken, @NotBlank String deviceName, @NotBlank UUID deviceId) {
        ...
        RefreshToken foundRefreshToken = refreshTokenRepository.findByHashedTokenAndRevokedFalse(hashedRefreshToken)
    ...
    public boolean checkTokenValidity(String refreshToken) {
        String hashedRefreshToken = refreshTokenGenerator.hashRefreshToken(refreshToken);
        RefreshToken refreshTokenEntity = refreshTokenRepository.findByHashedTokenAndRevokedFalse(hashedRefreshToken)
                .orElse(null);
